...
const scenes = ["事前", "ルール説明", "HO配布", "プロローグ", "神父追加HO", "解説"];
...
export class Scenario extends AScenario {
  ...
  async scene(_scene: string): Promise<void> {
    ...
    if (_scene === "事前") {
      ...
      await chCommonInfo.send({content: "【PC1】旅人\n" +
      ...
      await chCommonInfo.send({content: "【PC2】神父\n" +
      ...
      await chCommonInfo.send({content: "【PC5】羊飼い\n" +
